...
console.log('\n此脚本需要sqlite3模块。');
console.log('由于当前环境npm安装有问题，请手动执行以下步骤：');
console.log('\n方法1：双击运行 init-database.bat');
console.log('方法2：在CMD中执行:');
console.log('   cd /d "e:\\Trae lws\\LWS_web_sqlite"');
console.log('   npm install');
console.log('   npm run init-db');
console.log('\n或者你可以下载DB Browser for SQLite手动创建表结构。');
console.log('\n初始化SQL语句已保存到 init-sql.txt 文件中。');

fs.writeFileSync('init-sql.txt', initSQL);
console.log('\n✓ SQL语句已保存到: init-sql.txt');
